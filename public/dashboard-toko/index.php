                                ...
                                <td>
                                    <?php if ($item1->status): ?>
                                        <span class="badge 
                                            ...
                                            $status = strtolower($item1->status);
                                            if ($status == 'menunggu pembayaran') echo 'bg-secondary';
                                            elseif ($status == 'diproses') echo 'bg-warning text-dark';
                                            elseif ($status == 'dikirim') echo 'bg-info text-dark';
                                            elseif ($status == 'selesai') echo 'bg-success';
                                            elseif ($status == 'dibatalkan') echo 'bg-danger';
                                            else echo 'bg-dark';
                                            ?>">
                                            <?= $item1->status ?>
                                        </span>
